...
fn decodeFast(opcode: u8) Instruction(.Fast) {
    ...
    return switch (opcode) {
        ...
        0x10 => .{ .op = OpFast.OpBpl, .addressing = AddrFast.Relative, .cycles = 3 },
        0x30 => .{ .op = OpFast.OpBmi, .addressing = AddrFast.Relative, .cycles = 3 },
        0x50 => .{ .op = OpFast.OpBvc, .addressing = AddrFast.Relative, .cycles = 3 },
        0x70 => .{ .op = OpFast.OpBvs, .addressing = AddrFast.Relative, .cycles = 3 },
        0x90 => .{ .op = OpFast.OpBcc, .addressing = AddrFast.Relative, .cycles = 3 },
        0xb0 => .{ .op = OpFast.OpBcs, .addressing = AddrFast.Relative, .cycles = 3 },
        0xd0 => .{ .op = OpFast.OpBne, .addressing = AddrFast.Relative, .cycles = 3 },
        0xf0 => .{ .op = OpFast.OpBeq, .addressing = AddrFast.Relative, .cycles = 3 },
