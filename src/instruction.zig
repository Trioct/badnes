...
fn decodeFast(opcode: u8) Instruction(.fast) {
    ...
    return switch (opcode) {
        ...
        0x65 => .{ .op = OpFast.op_adc, .addressing = AddrFast.zero_page, .cycles = 3 },
        0x75 => .{ .op = OpFast.op_adc, .addressing = AddrFast.zero_page_x, .cycles = 4 },
        0x6d => .{ .op = OpFast.op_adc, .addressing = AddrFast.absolute, .cycles = 4 },
        0x7d => .{ .op = OpFast.op_adc, .addressing = AddrFast.absolute_x, .cycles = 4, .var_cycles = true },
        0x79 => .{ .op = OpFast.op_adc, .addressing = AddrFast.absolute_y, .cycles = 4, .var_cycles = true },
        0x61 => .{ .op = OpFast.op_adc, .addressing = AddrFast.indirect_x, .cycles = 6 },
        0x71 => .{ .op = OpFast.op_adc, .addressing = AddrFast.indirect_y, .cycles = 5, .var_cycles = true },

        0x29 => .{ .op = OpFast.op_and, .addressing = AddrFast.immediate, .cycles = 2 },
        0x25 => .{ .op = OpFast.op_and, .addressing = AddrFast.zero_page, .cycles = 3 },
        0x35 => .{ .op = OpFast.op_and, .addressing = AddrFast.zero_page_x, .cycles = 4 },
        0x2d => .{ .op = OpFast.op_and, .addressing = AddrFast.absolute, .cycles = 4 },
        0x3d => .{ .op = OpFast.op_and, .addressing = AddrFast.absolute_x, .cycles = 4, .var_cycles = true },
        0x39 => .{ .op = OpFast.op_and, .addressing = AddrFast.absolute_y, .cycles = 4, .var_cycles = true },
        0x21 => .{ .op = OpFast.op_and, .addressing = AddrFast.indirect_x, .cycles = 6 },
        0x31 => .{ .op = OpFast.op_and, .addressing = AddrFast.indirect_y, .cycles = 5, .var_cycles = true },

        0x0a => .{ .op = OpFast.op_asl, .addressing = AddrFast.accumulator, .cycles = 2 },
        0x06 => .{ .op = OpFast.op_asl, .addressing = AddrFast.zero_page, .cycles = 5 },
        0x16 => .{ .op = OpFast.op_asl, .addressing = AddrFast.zero_page_x, .cycles = 6 },
        0x0e => .{ .op = OpFast.op_asl, .addressing = AddrFast.absolute, .cycles = 6 },
        0x1e => .{ .op = OpFast.op_asl, .addressing = AddrFast.absolute_x, .cycles = 7 },
        ...
        0x24 => .{ .op = OpFast.op_bit, .addressing = AddrFast.zero_page, .cycles = 3 },
        ...
        0xc5 => .{ .op = OpFast.op_cmp, .addressing = AddrFast.zero_page, .cycles = 3 },
        0xd5 => .{ .op = OpFast.op_cmp, .addressing = AddrFast.zero_page_x, .cycles = 4 },
        0xcd => .{ .op = OpFast.op_cmp, .addressing = AddrFast.absolute, .cycles = 4 },
        0xdd => .{ .op = OpFast.op_cmp, .addressing = AddrFast.absolute_x, .cycles = 4, .var_cycles = true },
        0xd9 => .{ .op = OpFast.op_cmp, .addressing = AddrFast.absolute_y, .cycles = 4, .var_cycles = true },
        0xc1 => .{ .op = OpFast.op_cmp, .addressing = AddrFast.indirect_x, .cycles = 6 },
        0xd1 => .{ .op = OpFast.op_cmp, .addressing = AddrFast.indirect_y, .cycles = 5, .var_cycles = true },

        0xe0 => .{ .op = OpFast.op_cpx, .addressing = AddrFast.immediate, .cycles = 2 },
        0xe4 => .{ .op = OpFast.op_cpx, .addressing = AddrFast.zero_page, .cycles = 3 },
        0xec => .{ .op = OpFast.op_cpx, .addressing = AddrFast.absolute, .cycles = 4 },

        0xc0 => .{ .op = OpFast.op_cpy, .addressing = AddrFast.immediate, .cycles = 2 },
        0xc4 => .{ .op = OpFast.op_cpy, .addressing = AddrFast.zero_page, .cycles = 3 },
        0xcc => .{ .op = OpFast.op_cpy, .addressing = AddrFast.absolute, .cycles = 4 },

        0xc6 => .{ .op = OpFast.op_dec, .addressing = AddrFast.zero_page, .cycles = 5 },
        0xd6 => .{ .op = OpFast.op_dec, .addressing = AddrFast.zero_page_x, .cycles = 6 },
        0xce => .{ .op = OpFast.op_dec, .addressing = AddrFast.absolute, .cycles = 6 },
        0xde => .{ .op = OpFast.op_dec, .addressing = AddrFast.absolute_x, .cycles = 7 },
        ...
        0x45 => .{ .op = OpFast.op_eor, .addressing = AddrFast.zero_page, .cycles = 3 },
        0x55 => .{ .op = OpFast.op_eor, .addressing = AddrFast.zero_page_x, .cycles = 4 },
        0x4d => .{ .op = OpFast.op_eor, .addressing = AddrFast.absolute, .cycles = 4 },
        0x5d => .{ .op = OpFast.op_eor, .addressing = AddrFast.absolute_x, .cycles = 4, .var_cycles = true },
        0x59 => .{ .op = OpFast.op_eor, .addressing = AddrFast.absolute_y, .cycles = 4, .var_cycles = true },
        0x41 => .{ .op = OpFast.op_eor, .addressing = AddrFast.indirect_x, .cycles = 6 },
        0x51 => .{ .op = OpFast.op_eor, .addressing = AddrFast.indirect_y, .cycles = 5, .var_cycles = true },

        0xe6 => .{ .op = OpFast.op_inc, .addressing = AddrFast.zero_page, .cycles = 5 },
        0xf6 => .{ .op = OpFast.op_inc, .addressing = AddrFast.zero_page_x, .cycles = 6 },
        0xee => .{ .op = OpFast.op_inc, .addressing = AddrFast.absolute, .cycles = 6 },
        0xfe => .{ .op = OpFast.op_inc, .addressing = AddrFast.absolute_x, .cycles = 7 },
        ...
        0xa5 => .{ .op = OpFast.op_lda, .addressing = AddrFast.zero_page, .cycles = 3 },
        0xb5 => .{ .op = OpFast.op_lda, .addressing = AddrFast.zero_page_x, .cycles = 4 },
        0xad => .{ .op = OpFast.op_lda, .addressing = AddrFast.absolute, .cycles = 4 },
        0xbd => .{ .op = OpFast.op_lda, .addressing = AddrFast.absolute_x, .cycles = 4, .var_cycles = true },
        0xb9 => .{ .op = OpFast.op_lda, .addressing = AddrFast.absolute_y, .cycles = 4, .var_cycles = true },
        0xa1 => .{ .op = OpFast.op_lda, .addressing = AddrFast.indirect_x, .cycles = 6 },
        0xb1 => .{ .op = OpFast.op_lda, .addressing = AddrFast.indirect_y, .cycles = 5, .var_cycles = true },

        0xa2 => .{ .op = OpFast.op_ldx, .addressing = AddrFast.immediate, .cycles = 2 },
        0xa6 => .{ .op = OpFast.op_ldx, .addressing = AddrFast.zero_page, .cycles = 3 },
        0xb6 => .{ .op = OpFast.op_ldx, .addressing = AddrFast.zero_page_y, .cycles = 4 },
        0xae => .{ .op = OpFast.op_ldx, .addressing = AddrFast.absolute, .cycles = 4 },
        0xbe => .{ .op = OpFast.op_ldx, .addressing = AddrFast.absolute_y, .cycles = 4, .var_cycles = true },

        0xa0 => .{ .op = OpFast.op_ldy, .addressing = AddrFast.immediate, .cycles = 2 },
        0xa4 => .{ .op = OpFast.op_ldy, .addressing = AddrFast.zero_page, .cycles = 3 },
        0xb4 => .{ .op = OpFast.op_ldy, .addressing = AddrFast.zero_page_x, .cycles = 4 },
        0xac => .{ .op = OpFast.op_ldy, .addressing = AddrFast.absolute, .cycles = 4 },
        0xbc => .{ .op = OpFast.op_ldy, .addressing = AddrFast.absolute_x, .cycles = 4, .var_cycles = true },

        0x4a => .{ .op = OpFast.op_lsr, .addressing = AddrFast.accumulator, .cycles = 2 },
        0x46 => .{ .op = OpFast.op_lsr, .addressing = AddrFast.zero_page, .cycles = 5 },
        0x56 => .{ .op = OpFast.op_lsr, .addressing = AddrFast.zero_page_x, .cycles = 6 },
        0x4e => .{ .op = OpFast.op_lsr, .addressing = AddrFast.absolute, .cycles = 6 },
        0x5e => .{ .op = OpFast.op_lsr, .addressing = AddrFast.absolute_x, .cycles = 7 },

        0xea => .{ .op = OpFast.op_nop, .addressing = AddrFast.implied, .cycles = 2 },

        0x09 => .{ .op = OpFast.op_ora, .addressing = AddrFast.immediate, .cycles = 2 },
        0x05 => .{ .op = OpFast.op_ora, .addressing = AddrFast.zero_page, .cycles = 3 },
        0x15 => .{ .op = OpFast.op_ora, .addressing = AddrFast.zero_page_x, .cycles = 4 },
        0x0d => .{ .op = OpFast.op_ora, .addressing = AddrFast.absolute, .cycles = 4 },
        0x1d => .{ .op = OpFast.op_ora, .addressing = AddrFast.absolute_x, .cycles = 4, .var_cycles = true },
        0x19 => .{ .op = OpFast.op_ora, .addressing = AddrFast.absolute_y, .cycles = 4, .var_cycles = true },
        0x01 => .{ .op = OpFast.op_ora, .addressing = AddrFast.indirect_x, .cycles = 6 },
        0x11 => .{ .op = OpFast.op_ora, .addressing = AddrFast.indirect_y, .cycles = 5, .var_cycles = true },
        ...
        0x26 => .{ .op = OpFast.op_rol, .addressing = AddrFast.zero_page, .cycles = 5 },
        0x36 => .{ .op = OpFast.op_rol, .addressing = AddrFast.zero_page_x, .cycles = 6 },
        0x2e => .{ .op = OpFast.op_rol, .addressing = AddrFast.absolute, .cycles = 6 },
        0x3e => .{ .op = OpFast.op_rol, .addressing = AddrFast.absolute_x, .cycles = 7 },

        0x6a => .{ .op = OpFast.op_ror, .addressing = AddrFast.accumulator, .cycles = 2 },
        0x66 => .{ .op = OpFast.op_ror, .addressing = AddrFast.zero_page, .cycles = 5 },
        0x76 => .{ .op = OpFast.op_ror, .addressing = AddrFast.zero_page_x, .cycles = 6 },
        0x6e => .{ .op = OpFast.op_ror, .addressing = AddrFast.absolute, .cycles = 6 },
        0x7e => .{ .op = OpFast.op_ror, .addressing = AddrFast.absolute_x, .cycles = 7 },
        ...
        0xe5 => .{ .op = OpFast.op_sbc, .addressing = AddrFast.zero_page, .cycles = 3 },
        0xf5 => .{ .op = OpFast.op_sbc, .addressing = AddrFast.zero_page_x, .cycles = 4 },
        0xed => .{ .op = OpFast.op_sbc, .addressing = AddrFast.absolute, .cycles = 4 },
        0xfd => .{ .op = OpFast.op_sbc, .addressing = AddrFast.absolute_x, .cycles = 4, .var_cycles = true },
        0xf9 => .{ .op = OpFast.op_sbc, .addressing = AddrFast.absolute_y, .cycles = 4, .var_cycles = true },
        0xe1 => .{ .op = OpFast.op_sbc, .addressing = AddrFast.indirect_x, .cycles = 6 },
        0xf1 => .{ .op = OpFast.op_sbc, .addressing = AddrFast.indirect_y, .cycles = 5, .var_cycles = true },
        ...
        0x85 => .{ .op = OpFast.op_sta, .addressing = AddrFast.zero_page, .cycles = 3 },
        0x95 => .{ .op = OpFast.op_sta, .addressing = AddrFast.zero_page_x, .cycles = 4 },
        0x8d => .{ .op = OpFast.op_sta, .addressing = AddrFast.absolute, .cycles = 4 },
        0x9d => .{ .op = OpFast.op_sta, .addressing = AddrFast.absolute_x, .cycles = 5 },
        0x99 => .{ .op = OpFast.op_sta, .addressing = AddrFast.absolute_y, .cycles = 5 },
        0x81 => .{ .op = OpFast.op_sta, .addressing = AddrFast.indirect_x, .cycles = 6 },
        0x91 => .{ .op = OpFast.op_sta, .addressing = AddrFast.indirect_y, .cycles = 6 },

        0x86 => .{ .op = OpFast.op_stx, .addressing = AddrFast.zero_page, .cycles = 3 },
        0x96 => .{ .op = OpFast.op_stx, .addressing = AddrFast.zero_page_y, .cycles = 4 },
        0x8e => .{ .op = OpFast.op_stx, .addressing = AddrFast.absolute, .cycles = 4 },

        0x84 => .{ .op = OpFast.op_sty, .addressing = AddrFast.zero_page, .cycles = 3 },
        0x94 => .{ .op = OpFast.op_sty, .addressing = AddrFast.zero_page_x, .cycles = 4 },
